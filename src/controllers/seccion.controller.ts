...
import { SeccionDto } from '../models/seccion.dtoSchema';
...
export class SeccionController {
    ...
    async post(@Res() res, @Body() seccionDto: SeccionDto) {
        this.seccionService.post(seccionDto).then(seccion => {
    ...
    async getAll(@Res() res, @Query() filterDto: FilterDto) {
        this.seccionService.getAll(filterDto).then(seccion => {
    ...
    async getById(@Res() res, @Param('id') id: string) {
        this.seccionService.getById(id).then(seccion => {
            res.status(HttpStatus.OK).json({
                Success: true,
                Status: HttpStatus.OK,
                Message: 'Request successful',
    ...
    async put(@Res() res, @Param('id') id: string, @Body() seccionDto: SeccionDto) {
        this.seccionService.put(id, seccionDto).then(seccion => {
            res.status(HttpStatus.OK).json({
                Success: true,
                Status: HttpStatus.OK,
    ...
    async delete(@Res() res, @Param('id') id: string) {
        this.seccionService.delete(id).then(seccion => {
            res.status(HttpStatus.OK).json({
                Success: true,
                Status: HttpStatus.OK,
