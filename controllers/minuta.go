...
func (c *MinutaController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		...
		if err := services.CreateMinuta(v); err == nil {
...
func (c *MinutaController) GetAll() {
	minutas, err := services.ReadMinuta()
	if err != nil {
		logs.Error(err)
		...
		// }
		c.Data["json"] = map[string]interface{}{"Success": true, "Status": "200", "Message": "Request successful", "Data": minutas}
	}
	c.ServeJSON()
}
...
func (c *MinutaController) Put() {
	...
	var v models.Minuta
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := services.UpdateMinuta(v, idStr); err == nil {
			c.Data["json"] = v
		} else {
			logs.Error(err)
			//c.Data["development"] = map[string]interface{}{"Code": "000", "Body": err.Error(), "Type": "error"}
